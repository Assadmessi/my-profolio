        ...
        <div>
             <div className="text-white pt-2 px-4 ">
                ...
                <p className="mt-5">
                    ...
                    </a>                E-commerce site for the company using the shopfiy. I also am responsible for maintaining that website and managing the content of                 <a href="https://www.grandwynngroup.com" target={"_blank"} rel="noreferrer" className="text-gray-300 hover:text-brown">
